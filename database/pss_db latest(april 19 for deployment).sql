...
CREATE TABLE `activity_logs` (
  ...
  `action` enum('add','update','delete','archive','restore','inactive') NOT NULL,
...
INSERT INTO `activity_logs` VALUES (2,8,'restore',27,'Downy Antibac Fabric Conditioner','status','archived','active','2026-04-18 22:03:57'),(3,8,'archive',27,'Downy Antibac Fabric Conditioner','status','active','archived','2026-04-18 22:04:13');
...
-- Dump completed on 2026-04-19  6:05:23
