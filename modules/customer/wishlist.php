        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <?php while ($item = $result->fetch_assoc()): ?>
                ...
                <div class="bg-white border rounded-xl shadow-sm overflow-hidden flex flex-col hover:shadow-lg transition">
                    ...
                    <div class="relative h-48 w-full bg-gray-100 flex justify-center items-center overflow-hidden">
                        <?php if ($item['image_url']): ?>
                            <img src="<?php echo htmlspecialchars($item['image_url']); ?>" alt="<?php echo htmlspecialchars($item['name']); ?>" class="object-contain h-full w-full p-2 transition-transform duration-300">
                        <?php else: ?>
